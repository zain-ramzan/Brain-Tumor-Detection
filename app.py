...
# st.title('MRI Dataset')

# uploaded_image = st.file_uploader("Upload an MRI Image", type=["jpg", "jpeg"])

# if uploaded_image is not None:
#     image = Image.open(uploaded_image).convert("L").resize((28, 28))
#     st.image(image)
